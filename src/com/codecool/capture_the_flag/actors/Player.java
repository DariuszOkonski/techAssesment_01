...
public abstract class Player extends Actor {
    ...
    public Player(String name, GameMap mapReference) {
        super(mapReference);
        this.name = name;
        this.alive = true;
     ...
     *
     * @param otherPlayer
     * @return 1 if this player won, 0 if the other player won,
     * - 1 if fight didn't happened (otherPlayer is a teammate)
     * */
